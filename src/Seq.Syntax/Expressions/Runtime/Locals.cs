...
class Locals
{
    ...
    Locals(Locals? others, string name, JsonNode? value)
    {
        _others = others;
        _name = name;
        _value = value;
    ...
    public static Locals Set(Locals? others, string name, JsonNode? value)
    {
        return new Locals(others, name, value);
    }

    public static bool TryGetValue(Locals? locals, string name, out JsonNode? value)
    {
        while (locals != null)
        {
