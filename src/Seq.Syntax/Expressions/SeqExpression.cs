...
public static class SeqExpression
{
    ...
    /// <returns>A function that evaluates the expression in the context of an event JSON document.</returns>
    ...
    /// </summary>
    /// <param name="expression">An expression.</param>
    /// <param name="result">A function that evaluates the expression in the context of an event JSON document.</param>
